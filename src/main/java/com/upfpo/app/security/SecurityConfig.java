...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {	
		...
		.antMatchers("/signin","/home/farmer","/signin/password/otp/generate","/signin/password/otp/verify",
				...
				"/complaint/download/**",
				"/inputsupplier/insecticide/download/**",
				"/inputsupplier/fertilizer/download/**",
				"/inputsupplier/machinery/download/**",
				"/inputsupplier/seed/download/**",
				"/fpoguidelines/getall",
				"/fpoguidelines/{type}",
				"/marketablesurplus/**",
				"/equipmenttype/getall/**",
				"/api/InputSupplier/profile/inputsupplier/**",
				"/api/v1/CHCFMB/profile/ChcFmbDetail/**",
				"/upagri/getUpAgri/*",
				"/fpoDashboard/farmerDetails/**",
				"/fpoDashboard/getFinancialYears/**",
				"/inputsupplier/machinery/getall/**",
