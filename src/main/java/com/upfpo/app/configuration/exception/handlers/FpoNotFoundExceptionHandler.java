...
@ControllerAdvice
public class FpoNotFoundExceptionHandler extends ResponseEntityExceptionHandler {

	@ExceptionHandler(FpoNotFoundException.class)
    public ResponseEntity<Object> handleExceptions(FpoNotFoundException exception, WebRequest webRequest) {
