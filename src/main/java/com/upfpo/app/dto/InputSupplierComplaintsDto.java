...
public class InputSupplierComplaintsDto {
	...
	public InputSupplierComplaintsDto(Integer id, Integer masterId, String role, String title, String message,
			String status, String issueType, String otherType, String description, String otherAssigned,
			String assignTo, String assignBy, String assign_date, String resolve_date, String deptComment,
			String remarks, String filePath, String fileName, String uploadDate, String uploadedBy, String updateDate,
			String updateBy, Boolean isDeleted, String deleteDate, String createBy,
			String inputSupplierName, String email, BigInteger mobileNumber) {
		super();
		this.id = id;
