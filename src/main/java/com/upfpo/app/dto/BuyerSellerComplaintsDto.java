...
public class BuyerSellerComplaintsDto {
	...
	public BuyerSellerComplaintsDto(Integer id, Integer masterId, String role, String title, String message,
			...
			String buyerSellerName, String email, BigInteger mobileNumber) {
		super();
		this.id = id;
