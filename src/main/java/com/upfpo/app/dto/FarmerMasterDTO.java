...
public class FarmerMasterDTO 
{
		...
		public FarmerMasterDTO(Integer farmerId, Integer stateref, Integer pincode, Integer blockRef,
				Integer distRefId, Integer bankRefId, Integer fpoRefId, Integer villRefId, 
				Integer educationId, String farmerName, String farmerAdhaar, String farmerAddress, String registerDate,
				Long farmerMob, String farmerLotNo, String ifscCode, Long accountNo, Long kccno, String parantsName,
				String createDate, String createdBy, boolean enabled, String gender,
				String farmerUserName, String category, String updateDate, String agency, String upBSMId,
				Integer villagePanchayatId, boolean isDeleted, String deleteDate, String updatedBy, Integer user_id) {
			super();
			this.farmerId = farmerId;
			this.stateref = stateref;
			this.pincode = pincode;
