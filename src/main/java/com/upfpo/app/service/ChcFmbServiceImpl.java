	...
	public ChcFmbDTO getChcFmbProfileById(Integer masterId) {
		...
		try {
			String sql = "select chc.chc_fmb_id, chc.chc_fmb_name, u.user_name, dst.district_id, dst.district_name, blk.block_id,\n" +
					...
					"\t\tchc.mobile_number, chc.firm_registraion_number, chc.shop_establishment_number, chc.allotment_no, chc.contact_person as contactPerson, chc.chc_fmb_type as chcFmbType from chc_fmb chc\n" +
