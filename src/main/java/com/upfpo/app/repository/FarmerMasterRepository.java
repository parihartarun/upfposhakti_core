...
public interface FarmerMasterRepository extends JpaRepository<FarmerMaster, Integer>
{
	...
	@Query("select new com.upfpo.app.dto.FarmerDetailsDTO(f.farmerId, f.farmerName, f.upBSMId) from FarmerMaster f where f.fpoRefId = :masterId and f.isDeleted = false and f.userFar.isEnabled = true")
