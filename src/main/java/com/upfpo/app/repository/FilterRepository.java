...
public class FilterRepository {
	...
	public List<DistrictFilterDto> getDistrictsByFilterKeys(String val,String in)
	{
		String sql ="";
if(in.equalsIgnoreCase(FilterRepository.ANY))
{
	sql = "select distinct districts.district_name districtName, districts.district_id as districtId from fpo \r\n"
